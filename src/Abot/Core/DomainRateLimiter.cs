...
namespace Abot.Core
{
    ...
    public class DomainRateLimiter : IDomainRateLimiter
    {
        ...
        private ConcurrentDictionary<string, IRateLimiter> _rateLimiterLookup = new ConcurrentDictionary<string, IRateLimiter>();
        private long _defaultMinCrawlDelayInMillisecs;
